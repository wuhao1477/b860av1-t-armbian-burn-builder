...
export function replaceLinuxTargetDtb(vendorPath, linuxPath, outputPath) {
  ...
  const selected = vendor.entries.find((entry) => entry.target === 'gxl_p215_1g');
  if (!selected || linux.fdtSize > selected.size) fail('Linux FDT does not fit the selected vendor DTB slot');
